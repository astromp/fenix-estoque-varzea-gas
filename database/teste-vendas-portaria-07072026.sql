-- Projeto Fênix Estoque — Teste 2: vendas da Portaria
-- Banco: Supabase / PostgreSQL
-- Objetivo: lançar apenas as vendas da Portaria no dia 07/07/2026.
...
-- 1. Criar lançamento da Portaria
with dados as (
  select
  ...
  select
    ...
    canal_venda_id,
    'venda',
    timestamp with time zone '2026-07-07 08:30:00-03',
    'Portaria: vendas da simulação'
  from dados
...
select
  ...
  'venda_liquido',
  v.quantidade,
  'Venda do líquido pela Portaria'
